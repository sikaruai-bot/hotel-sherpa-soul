...
export const metadata: Metadata = {
  ...
  description: 'Experience genuine Sherpa hospitality in Thamel, Kathmandu. A quiet sanctuary with 6 clean rooms, shared kitchen, and a peaceful environment to recharge.',
